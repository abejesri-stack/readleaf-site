    ...
    <div style={{ minHeight: '100vh', background: 'var(--color-oatmeal)', color: 'var(--color-ink)' }}>
      ...
      <main style={{ maxWidth: '920px', margin: '0 auto', padding: '0 var(--space-4) var(--space-16)' }}>
        ...
        <section style={{ marginBottom: 'var(--space-12)', paddingTop: 'var(--space-5)', borderTop: '1px solid rgba(43,43,43,0.08)' }}>
          ...
          <p style={{ ...textStyle, marginBottom: 'var(--space-3)' }}>
            If your main goal is legal free reading, see our guide to the <Link to="/guides/best-free-ebook-apps-iphone" style={{ color: 'var(--color-accent)' }}>best free eBook apps for iPhone</Link>.
          </p>
          <p style={{ ...textStyle, marginBottom: 'var(--space-3)' }}>
          ...
          <p style={{ ...textStyle, marginBottom: 'var(--space-3)' }}>
            If you mainly want public-domain books and classic literature, see our guide to the <Link to="/guides/best-apps-for-reading-classics-iphone" style={{ color: 'var(--color-accent)' }}>best apps for reading classics on iPhone</Link>.
          </p>
          <p style={{ ...textStyle, margin: 0 }}>
